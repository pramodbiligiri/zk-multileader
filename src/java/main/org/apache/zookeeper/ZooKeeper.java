...
public class ZooKeeper {
    ...
    public ZooKeeper(String connectString, int sessionTimeout, Watcher watcher)
        throws IOException
    {
        this(connectString, sessionTimeout, watcher, false, null);
    }
     ...
     */
    public ZooKeeper(String connectString, int sessionTimeout, Watcher watcher,
            boolean canBeReadOnly, String path)
        throws IOException
    {
        ...
        cnxn = new ClientCnxn(connectStringParser.getChrootPath(),
                ...
                getClientCnxnSocket(), canBeReadOnly, path);
        cnxn.start();
    }
    ...
    public ZooKeeper(String connectString, int sessionTimeout, Watcher watcher,
        ...
        throws IOException
    {
        this(connectString, sessionTimeout, watcher, sessionId, sessionPasswd, false, null);
    }
     ...
     */
    public ZooKeeper(String connectString, int sessionTimeout, Watcher watcher,
            long sessionId, byte[] sessionPasswd, boolean canBeReadOnly, String path)
        throws IOException
    {
        LOG.info("Initiating client connection, connectString=" + connectString
        ...
        cnxn = new ClientCnxn(connectStringParser.getChrootPath(),
                hostProvider, sessionTimeout, this, watchManager,
                getClientCnxnSocket(), sessionId, sessionPasswd, canBeReadOnly, path);
