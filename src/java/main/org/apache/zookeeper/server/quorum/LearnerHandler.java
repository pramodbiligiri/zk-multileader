...
public class LearnerHandler extends Thread {
    ...
    LearnerHandler(Socket sock, Leader leader, int quorumId) throws IOException {
        super("LearnerHandler[quorumId="+quorumId+"]-" + sock.getRemoteSocketAddress());
        this.sock = sock;
        this.leader = leader;
    ...
    public void run() {
        try {
            ...
            try {
                ...
                LOG.info("Sending " + Leader.getPacketType(packetToSend) +" to " + this.sid);
