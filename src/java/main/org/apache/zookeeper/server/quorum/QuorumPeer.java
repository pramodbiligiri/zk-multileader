...
//    	new Exception("In quorum size").printStackTrace();
//    	throw new NotImplementedException();
        int quorumSize = getVotingView().size();
//        LOG.debug("Request for quorum size:" + quorumSize);
		return quorumSize;
    }
    ...
    protected Follower makeFollower(FileTxnSnapLog logFactory) throws IOException {
        return new Follower(this, new FollowerZooKeeperServer(logFactory, 
                quorumPeerMulti, new ZooKeeperServer.BasicDataTreeBuilder(), this.zkDb));
//        return new Follower(this, new FollowerZooKeeperServer(logFactory, 
//        	this , new ZooKeeperServer.BasicDataTreeBuilder(), this.zkDb));
    ...
    protected Election createElectionAlgorithm(int electionAlgorithm){
        ...
        case 3:
            ...
            break;
        case 4:
        	le = new MockMultiLeaderElection(this, 3);
        	break;
        case 5:
        	le = new MockMultiLeaderElection(this, 5);
        	break;
        default:
            assert false;
        }
    ...
    @Override
    public void run() {
    	MDC.put("quorumId", String.valueOf(quorumId));
    	
    	if(startClientConnection){
    		setName("QuorumPeer" + "[myid=" + getId() + ",quorumId="+quorumId+"]" +
                cnxnFactory.getLocalAddress());
    	}else{
    		setName("QuorumPeer" + "[myid=" + getId() + ",quorumId="+quorumId+"] noClientPort");
    	}
        ...
        try {
            ...
            while (running) {
                switch (getPeerState()) {
                case LOOKING:
                    LOG.info("quorumId="+quorumId+":LOOKING");
                ...
                case FOLLOWING:
                    try {
                        LOG.info("quorumId="+quorumId+":FOLLOWING");
                    ...
                    break;
                case LEADING:
                    LOG.info("quorumId="+quorumId+":LEADING");
                    try {
